...
# PAGE_VIEW_PATH = 'D:/University/Information Retrieval/Project/data_to_work_with/pageviews-202108-user.pkl'
...
#   return pd.DataFrame({'page_id': article_ids, 'score': [pageviews_dict.get(key) for key in article_ids]}).set_index('page_id')
