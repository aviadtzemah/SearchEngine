...
title_index = InvertedIndex.read_index('D:/University/InformationRetrieval/Project/data_to_work_with/title_postings_gcp/', 'index')
word, pls = get_posting_gen_binary('D:/University/InformationRetrieval/Project/data_to_work_with/title_postings_gcp/', title_index)
