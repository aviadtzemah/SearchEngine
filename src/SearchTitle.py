...
title_index = InvertedIndex.read_index('/home/aviadsha/data/title_postings_gcp/', 'index')
word, pls = get_posting_gen_binary('/home/aviadsha/data/title_postings_gcp/', title_index)
